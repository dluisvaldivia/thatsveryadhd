        ...
        <div className="container">
            <div className="row justify-content-center justify-content-md-start">
                ...
                <div className='col-12 col-md-8'>
                    ...
                    <p>My multicultural journey, from Paris to Madrid, Sydney, and now Malaga, has enriched my understanding of diverse life perspectives. My background in hospitality, travel & tourism, and culinary arts has further expanded my appreciation for global cultures and neurodiversity, fueling my passion for exploring new experiences and connecting with people from all over the world. Fluent in English, Spanish, and French, I am dedicated to building a vibrant, inclusive coaching practice that resonates with diverse clients globally.</p>

                    <p>As a co-founder of DownContigo, a non-profit organization advocating for neurodivergent children and their families, we are dedicated to improving lives through education, social inclusion, and promoting independent living. We are a passionate team organizing community events and support groups to foster an inclusive and empowering environment.</p>
